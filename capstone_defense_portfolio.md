...
| **TC-09** | **BCPC Nutrition** | Perform child assessment with WHO Growth Chart checks | Infant: Male, 24 Mos<br>Weight: 8.5kg | Weight-for-Age Status: **Severe Acute Malnutrition (SAM)**; log referral. | Child status flagged as SAM; intervention recommendation logged. | **PASS** |
| **TC-10** | **BCPC Nutrition** | Perform child assessment with normal metrics | Infant: Female, 12 Mos<br>Weight: 9.8kg | Weight-for-Age Status: **Normal**; save record. | Normal weight status flagged; assessment saved. | **PASS** |
