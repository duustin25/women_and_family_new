            ...
            <footer className="bg-[#1a0a25] dark:bg-black text-white border-t-[3px] border-purple-600">
                <div className="container mx-auto px-6 lg:px-10 pt-12 pb-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                        ...
                        {/* Quick Links */}
                        <div>
                            <h4 className="font-black uppercase tracking-widest mb-8 text-purple-400 italic text-sm">
                                Information Hub / Impormasyon
                            </h4>
                            <ul className="space-y-4 text-sm font-black uppercase tracking-widest text-slate-200">
                        ...
                        <div>
                            <h4 className="font-black uppercase tracking-widest mb-8 text-purple-400 italic text-sm">
                                24/7 Hotline Response
                            </h4>
                            <div className="space-y-4">
                                <a href={`tel:${brgyNum}`} className="block p-4 bg-purple-900/20 border border-purple-500/30 rounded-md group hover:border-purple-400 transition-all">
                                    <p className="text-sm font-black text-purple-300 uppercase mb-1 tracking-wider group-hover:text-purple-200">Emergency Brgy Hall</p>
                                    <p className="text-lg font-black text-white flex items-center gap-2">
                                        <Phone size={18} className="text-purple-400" /> {brgyNum}
                                    </p>
                                </a>
                                <a href={`tel:${vawcNum}`} className="block p-4 bg-red-950/20 border border-red-500/30 rounded-md group hover:border-red-500 transition-all">
                                    <p className="text-sm font-black text-red-400 uppercase mb-1 tracking-wider group-hover:text-red-200">VAWC Emergency Desk</p>
                                    <p className="text-lg font-black text-white flex items-center gap-2">
                                        <AlertCircle size={18} className="text-red-500 group-hover:animate-pulse" /> {vawcNum}
                                    </p>
                                </a>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="text-sm font-black tracking-widest text-slate-200 space-y-4">
                    ...
                    <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-xs font-black uppercase tracking-[0.2em] text-slate-400 text-center md:text-left">
                            © 2026 {brgyName}, {cityName} | Women & Family Support Management System
                        </p>
                        <div className="flex gap-6 text-xs font-black uppercase text-slate-400 tracking-widest italic underline decoration-slate-600 underline-offset-4">
