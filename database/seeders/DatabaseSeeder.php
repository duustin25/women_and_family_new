...
$defaultZones = [
['name' => 'Purok 1', 'color_code' => '#10b981', 'description' => 'Barangay 183 Villamor - Purok 1', 'is_active' =>
true],
['name' => 'Purok 2', 'color_code' => '#3b82f6', 'description' => 'Barangay 183 Villamor - Purok 2', 'is_active' =>
true],
['name' => 'Purok 3', 'color_code' => '#f59e0b', 'description' => 'Barangay 183 Villamor - Purok 3', 'is_active' =>
true],
['name' => 'Purok 4', 'color_code' => '#ef4444', 'description' => 'Barangay 183 Villamor - Purok 4', 'is_active' =>
true],
['name' => 'Purok 5', 'color_code' => '#8b5cf6', 'description' => 'Barangay 183 Villamor - Purok 5', 'is_active' =>
true],
['name' => 'Purok 6', 'color_code' => '#ec4899', 'description' => 'Barangay 183 Villamor - Purok 6', 'is_active' =>
true],
['name' => 'Purok 7', 'color_code' => '#6b7280', 'description' => 'Barangay 183 Villamor - Purok 7', 'is_active' =>
true],
['name' => 'Purok 8', 'color_code' => '#06b6d4', 'description' => 'Barangay 183 Villamor - Purok 8', 'is_active' =>
true],
];
...
$abuseTypes = [
['name' => 'Physical', 'category' => 'VAWC', 'color' => '#ef4444', 'description' => 'Bodily injury or physical harm.',
'is_active' => true],
['name' => 'Sexual', 'category' => 'VAWC', 'color' => '#2d00f5ff', 'description' => 'Sexual acts or coercion.',
'is_active' => true],
['name' => 'Psychological', 'category' => 'VAWC', 'color' => '#02ff0fff', 'description' => 'Mental distress or
harassment.', 'is_active' => true],
['name' => 'Economic', 'category' => 'VAWC', 'color' => '#fae903ff', 'description' => 'Deprivation of financial
resources.', 'is_active' => true],
['name' => 'Neglect / Nutritional Deprivation', 'category' => 'BCPC', 'color' => '#3b82f6', 'description' => 'Failure to
provide child nourishment or safety.', 'is_active' => true],
['name' => 'Child Labor Exploitation', 'category' => 'BCPC', 'color' => '#10b981', 'description' => 'Exploitative work
conditions for minors.', 'is_active' => true],
];
...
$vcoSchema = [
['id' => 'fullname', 'type' => 'text', 'label' => 'Full Name', 'required' => true, 'width' => 'w-full', 'layout' =>
'block', 'is_core' => true],
['id' => 'address', 'type' => 'text', 'label' => 'Address', 'required' => true, 'width' => 'w-full', 'layout' =>
'block', 'is_core' => true],
['id' => 'email', 'type' => 'email', 'label' => 'Email Address', 'required' => false, 'width' => 'w-full', 'layout' =>
'block', 'is_core' => true],

['id' => 'vco_dob', 'type' => 'date', 'label' => 'Date of Birth', 'required' => true, 'width' => 'w-1/2', 'layout' =>
'block'],
['id' => 'vco_age', 'type' => 'number', 'label' => 'Age', 'required' => true, 'width' => 'w-1/2', 'layout' => 'block'],

['id' => 'vco_school', 'type' => 'text', 'label' => 'School Name', 'required' => true, 'width' => 'w-1/2', 'layout' =>
'block'],
['id' => 'vco_grade', 'type' => 'text', 'label' => 'Grade Level', 'required' => true, 'width' => 'w-1/2', 'layout' =>
'block'],

['id' => 'vco_guardian', 'type' => 'text', 'label' => 'Parent/Guardian Name', 'required' => true, 'width' => 'w-full',
'layout' => 'block'],
['id' => 'vco_guardian_email', 'type' => 'email', 'label' => 'Parent/Guardian Email', 'required' => true, 'width' =>
'w-full', 'layout' => 'block'],
['id' => 'vco_guardian_phone', 'type' => 'text', 'label' => 'Parent/Guardian Phone Number', 'required' => true, 'width'
=> 'w-full', 'layout' => 'block'],

['id' => 'vco_confidentiality', 'type' => 'paragraph', 'label' => 'All information provided is kept confidential,
securely protected, and used only for membership and organizational purposes.', 'required' => false, 'width' =>
'w-full']
];
...
['id' => 'erpat_age', 'type' => 'number', 'label' => 'Age', 'required' => true, 'width' => 'w-1/3', 'layout' =>
'block'],
['id' => 'erpat_sex', 'type' => 'text', 'label' => 'Sex', 'required' => true, 'width' => 'w-1/3', 'layout' => 'block'],
['id' => 'erpat_dob', 'type' => 'date', 'label' => 'Date of Birth', 'required' => true, 'width' => 'w-1/3', 'layout' =>
'block'],
...
['id' => 'erpat_phone', 'type' => 'text', 'label' => 'Cellphone / Telephone No.', 'required' => true, 'width' =>
'w-full'],

['id' => 'erpat_status', 'type' => 'checkbox_group', 'label' => 'Status', 'required' => true, 'options' => ['Biological
Father', 'Solo Parent', 'Guardian', 'Foster Father', 'Adoptive Father', 'Others (specify)']],
...
['id' => 'erpat_attainment', 'type' => 'checkbox_group', 'label' => 'Educational Attainment', 'required' => true,
'options' => ['Elementary', 'High School', 'Vocational', 'College', 'Masteral/Doctorate']],
['id' => 'erpat_school', 'type' => 'text', 'label' => 'School Name', 'required' => true, 'width' => 'w-1/2'],
['id' => 'erpat_year_sem', 'type' => 'text', 'label' => 'Year / Semester Completed', 'required' => true, 'width' =>
'w-1/2'],

['id' => 'erpat_skills', 'type' => 'text', 'label' => 'Skills / Talents', 'required' => false],
['id' => 'erpat_hobbies', 'type' => 'text', 'label' => 'Hobbies', 'required' => false],

['id' => 'erpat_aff_school', 'type' => 'text', 'label' => 'Affiliations - School', 'required' => false, 'width' =>
'w-1/2'],
['id' => 'erpat_aff_civic', 'type' => 'text', 'label' => 'Affiliations - Civic', 'required' => false, 'width' =>
'w-1/2'],
['id' => 'erpat_aff_community', 'type' => 'text', 'label' => 'Affiliations - Community', 'required' => false, 'width' =>
'w-1/2'],
['id' => 'erpat_aff_work', 'type' => 'text', 'label' => 'Affiliations - Workplace', 'required' => false, 'width' =>
'w-1/2'],
['id' => 'erpat_aff_others', 'type' => 'text', 'label' => 'Affiliations - Others', 'required' => false, 'width' =>
'w-full'],

['id' => 'erpat_seminars', 'type' => 'repeater', 'label' => 'Seminars / Trainings Attended', 'required' => false,
'schema' => [
...
['id' => 'kalipi_sectoral', 'type' => 'checkbox_group', 'label' => 'Sectoral Categories', 'required' => true, 'options'
=> ['Person with disability (indicate)', 'Solo parent', 'IP (indicate)', 'Others']],
...
['id' => 'kalipi_company_address', 'type' => 'text', 'label' => 'Address of Company (if applicable)', 'required' =>
false, 'width' => 'w-1/2'],
['id' => 'kalipi_company_phone', 'type' => 'text', 'label' => 'Telephone no. (if applicable)', 'required' => false,
'width' => 'w-1/2'],
...
['id' => 'kalipi_other_org_address', 'type' => 'text', 'label' => 'Address of Organization (if any)', 'required' =>
false],
['id' => 'kalipi_other_org_pos', 'type' => 'text', 'label' => 'Position (if any)', 'required' => false, 'width' =>
'w-1/2'],
['id' => 'kalipi_other_org_date', 'type' => 'text', 'label' => 'Date of Membership (if any)', 'required' => false,
'width' => 'w-1/2'],
...
['id' => 'kalipi_consent', 'type' => 'paragraph', 'label' => 'I hereby permit the Kalipunan ng Liping Pilipina (KALIPI)
Nasyonal, Inc. and its chapters on the collection, use, sharing, and disposing of my data/information for the exclusive
purpose of implementing, administering, and managing my membership in the federation.', 'required' => false, 'width' =>
'w-full']
];
...
'type' => 'row',
'columns' => [
['title' => 'Recommended by:', 'name' => '', 'label' => 'Signature over printed name of the Head of Membership
Committee'],
['title' => 'Approved/Disapproved:', 'name' => '{president_name}', 'label' => 'Signature over printed name of the KALIPI
Barangay Chapter President']
]
]
]
];
...
['id' => 'solo_category', 'type' => 'text', 'label' => 'Category of being a Solo Parent', 'required' => true, 'width' =>
'w-full'],
...
'description' => 'Dedicated to empowering women through livelihood programs, GAD development seminars, and health
initiatives.',
...
'description' => 'Supporting persons with disabilities (PWD) and promoting inclusive opportunities, social benefits, and
...
'slug' => 'vco-youth',
'description' => 'A youth-led organization focused on child development, educational assistance, leadership seminars,
and child protection rights advocacy.',
...
'description' => 'Supporting single parents and their families through welfare benefits, mutual aid, skills training,
and emotional support groups.',
...
'name' => 'ERPAT (Fathers)',
'slug' => 'erpat-fathers',
'description' => 'Empowerment and Reaffirmation of Paternal Abilities Training, fostering responsible fatherhood, active
parenting, and family harmony.',
...
for ($i = 0; $i < 60; $i++) { $status='Pending' ; if ($i < 40) { $status='Approved' ; } elseif ($i>= 55) {
    $status = 'Disapproved';
    }
    ...
    ['Name' => $faker->name(), 'Sex' => $faker->randomElement(['Male', 'Female']), 'Relationship' => 'Child', 'Age' =>
    rand(1, 20)]
    ];
    $formData['erpat_seminars'] = [
    ['title' => 'Responsible Parenting Seminar', 'organizer' => 'Pasay City SWDD', 'date' => $faker->date('Y-m-d', '-1
    year')],
    ['title' => 'Family Health Program', 'organizer' => 'Barangay 183 Health Center', 'date' => $faker->date('Y-m-d',
    '-2 months')]
    ];
    ...
    $formData['kalipi_attainment'] = $faker->randomElement(['High School Graduate', 'College Level', 'College
    Graduate']);
    $formData['kalipi_occupation'] = $faker->jobTitle();
    $formData['kalipi_income'] = rand(10000, 35000) . ' PHP';
    $formData['kalipi_family_composition'] = [
    ['Name' => $faker->name('male'), 'Age' => rand(25, 60), 'Relationship to Member' => 'Husband', 'Highest Educational
    Attainment' => 'College', 'Occupation' => 'Driver', 'Income' => '15000', 'Remarks (Disability, IP, Solo Parent)' =>
    'None'],
    ['Name' => $faker->name(), 'Age' => rand(5, 18), 'Relationship to Member' => 'Child', 'Highest Educational
    Attainment' => 'Elementary', 'Occupation' => 'Student', 'Income' => '0', 'Remarks (Disability, IP, Solo Parent)' =>
    'None']
    ];
    ...
    $formData['kabahagi_disability'] = $faker->randomElement(['Visual Impairment', 'Orthopedic Disability', 'Hearing
    Impairment']);
    }
    ...
    'fullname' => $applicantName,
    'email' => $applicantEmail,
    'phone' => $formData['vco_guardian_phone'] ?? ($formData['erpat_phone'] ?? ($formData['kalipi_cellphone'] ??
    ($formData['solo_phone'] ?? ($formData['kabahagi_phone'] ?? $faker->phoneNumber())))),
