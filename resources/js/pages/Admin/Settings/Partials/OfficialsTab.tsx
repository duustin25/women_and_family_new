        ...
        <Card className="border shadow-sm">
            <CardHeader className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4">
                <div>
                    ...
                    <CardDescription>
                        Public governance directory displayed across citizen portals and official correspondences.
                    </CardDescription>
                </div>
                <div>
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-muted/40">
                                <TableHead className="w-12 text-center font-bold text-xs uppercase">Order</TableHead>
                                <TableHead className="font-bold text-xs uppercase">Official Name</TableHead>
                                <TableHead className="font-bold text-xs uppercase">Position & Committee</TableHead>
                                <TableHead className="font-bold text-xs uppercase">Hierarchy Level</TableHead>
                                <TableHead className="font-bold text-xs uppercase">Status</TableHead>
                                <TableHead className="text-right font-bold text-xs uppercase w-24">Actions</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                                    ...
                                    return (
                                        <TableRow key={off.id} className="hover:bg-muted/30">
                                            ...
                                            <TableCell>
                                                ...
                                                {off.user && (
                                                    <div className="text-xs text-muted-foreground">System Account Linked</div>
                                                )}
                                            </TableCell>
                                            <TableCell>
                                                <div className="font-medium text-sm">{off.position}</div>
                                                {off.committee && (
