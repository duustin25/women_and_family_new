...
class VawcController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'victim.alias' => 'nullable|string|max:255',
            'victim.age' => 'nullable|integer|min:0|max:120',
            'victim.birthdate' => 'nullable|date',
            'victim.birthplace' => 'nullable|string|max:255',
            'victim.nationality' => 'nullable|string|max:100',
            ...
            'weapons_used' => 'nullable|array',
            'substance_abuse' => 'nullable|array',
            ...
            'victim_shelter_choice' => 'nullable|string|max:255',
            'immediate_emergency_actions' => 'nullable|array',
            'is_bpo_consented_by_guardian' => 'boolean',
