...
class NutritionCalculatorService
{
     ...
     * automatically computes the child's exact age in months and evaluates 
     * weight/height metrics against standard deviation bands to classify them as Normal, 
     * Underweight (MAM), Severely Underweight (SAM), Stunted, or Severely Stunted. 
     * It completely automates the diagnostics.
     */
